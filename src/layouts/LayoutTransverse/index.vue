 ...
 * @LastEditTime: 2024-01-24 10:28:56
 * @FilePath: \yl_admin_base_project\src\layouts\LayoutTransverse\index.vue
...
<template>
  <el-container class="layout">
    <el-header>
      ...
      <el-menu mode="horizontal" :router="false" :default-active="activeMenu" :unique-opened="false">
